...
public final class QuestPool {
    ...
    public static final List<Quest> ALL = List.of(
            ...
            new Quest(Quest.Type.GATHER, "minecraft:emerald", 8, 7, "Gather 8 Emeralds"),
            new Quest(Quest.Type.GATHER, "minecraft:coal", 64, 4, "Gather 64 Coal"),
            new Quest(Quest.Type.GATHER, "minecraft:ender_pearl", 8, 8, "Gather 8 Ender Pearls"),
            ...
            new Quest(Quest.Type.KILL, "minecraft:enderman", 10, 8, "Slay 10 Endermen"),
            new Quest(Quest.Type.KILL, "minecraft:blaze", 8, 8, "Slay 8 Blazes"),
            new Quest(Quest.Type.KILL, "minecraft:piglin", 15, 6, "Slay 15 Piglins"),
            new Quest(Quest.Type.KILL, "minecraft:drowned", 15, 6, "Slay 15 Drowned"),
            new Quest(Quest.Type.KILL, "minecraft:witch", 8, 6, "Slay 8 Witches"),
