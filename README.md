...
The pushed texture pack is rebuilt with `tools/build-pack.sh <tag>`, which zips it and
patches its SHA-1 into every edition — they have to be produced together or the client
