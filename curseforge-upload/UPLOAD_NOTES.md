# CurseForge upload — VanillaSkills 2.1.8 (4 jars, no texture pack)

All four jars were **downloaded back from the published GitHub release** (`v2.1.8`) and byte-compared
...
> **No texture pack this time.** The pack did not change in 2.1.8 — the jars still point at the
...
**File:** `vanillaskills-2.1.8+mc26.2.jar` (this folder)
...
The CurseForge page jumps 2.0.1 → 2.1.8, so this covers all ten releases since:
...
VanillaSkills (the VSP Player/Server packs) from the 2.0.1 fileID to the 2.1.8 one and bump the pack
version.
